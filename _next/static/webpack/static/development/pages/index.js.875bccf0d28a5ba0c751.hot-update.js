...
})(["margin-top:1.5em;font-family:'Arimo',sans-serif;"]);
...
})(["font-family:'Arimo',sans-serif;text-align:center;font-weight:400;margin-top:0;font-size:large;"]);
...
})(["padding:1em 2em;text-align:center;font-family:'Arimo',sans-serif;line-height:1.5em;"]);
...
})(["border:solid 1px #eee;border-radius:4px;background:white;font-size:larger;padding:0.5em 1em;background:#09ea9c;"]);
...
})(["position:fixed;bottom:0;left:0;width:calc(100vw - 2em);height:50px;background:#F2F2F2;padding:0.25em 1em;display:flex;justify-content:space-between;align-items:center;"]);
...
var Index = function Index() {
  return react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_components_common__WEBPACK_IMPORTED_MODULE_2__["Page"], {
    ...
    __self: this
  }, "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat."), react__WEBPACK_IMPORTED_MODULE_0__["createElement"](CTA, {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 83
    },
    __self: this
  }, "\uD83E\uDD19\uD83C\uDFFC Let's talk!")), react__WEBPACK_IMPORTED_MODULE_0__["createElement"](Footer, {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 87
    },
...
//# sourceMappingURL=index.js.875bccf0d28a5ba0c751.hot-update.js.map
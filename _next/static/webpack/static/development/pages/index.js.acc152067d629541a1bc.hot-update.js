...
function () {
  function SlackBotClass(hookUrl) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_5__["default"])(this, "mapsUrl", function (lat, lon) {
      return "https://www.google.com/maps/?q=".concat(lat, ",").concat(lon);
    });

    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_5__["default"])(this, "mapsLink", function (city, country, lat, lon) {
      return "<".concat(_this.mapsUrl(lat, lon), "|").concat(city, ", ").concat(country, ">");
    });
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              location = _this.mapsLink(ipData.city, ipData.country_name, ipData.latitude, ipData.longitude);
...
//# sourceMappingURL=index.js.acc152067d629541a1bc.hot-update.js.map
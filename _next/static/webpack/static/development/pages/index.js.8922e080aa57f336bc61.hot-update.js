        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              ipData = _lib_IPSevice__WEBPACK_IMPORTED_MODULE_13__["IPService"].getIPData();
              gMapsLink = "https://www.google.com/maps/?q=".concat(ipData.postal, " ").concat(ipData.city, " ").concat(ipData.country_name);
              _lib_SlackBot__WEBPACK_IMPORTED_MODULE_12__["SlackBot"].sendTextMessage("\uD83D\uDCE7 User just triggered CTA <".concat(gMapsLink, "|").concat(ipData.city, ", ").concat(ipData.country_name, ">"));
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                gMapsLink = "https://www.google.com/maps/?q=".concat(ipData.postal, " ").concat(this.IP_DATA.city, " ").concat(this.IP_DATA.country_name);
...
//# sourceMappingURL=index.js.8922e080aa57f336bc61.hot-update.js.map
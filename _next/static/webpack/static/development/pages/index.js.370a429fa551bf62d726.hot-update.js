...
function () {
  function SlackBotClass(hookUrl) {
    ...
    _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee() {
      var ipData, siteVisitorId, visitType, message, visitor, location;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              visitor = "ID: ".concat(siteVisitorId);
              location = _this.mapsLink(ipData.postal, ipData.city, ipData.country_name);
...
//# sourceMappingURL=index.js.370a429fa551bf62d726.hot-update.js.map